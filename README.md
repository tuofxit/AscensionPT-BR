...
![Versão](https://img.shields.io/badge/versão-1.4.55-33ff99)
...
### Novidades da versão 1.4.55

- novas descrições e tooltips de habilidades da base 1.5.0 de GabrielBosco, sem traduzir os nomes das habilidades;
- revisão seletiva de missões e falas de NPC, preservando toda a cobertura exclusiva deste projeto;
- novos rótulos da ficha do personagem;
- agendador central para agrupar atualizações curtas da interface e reduzir temporizadores repetidos;
- pesquisa na Casa de Leilões usando nomes de itens em português ou inglês;
- validações adicionais de placeholders, sintaxe e preservação dos bancos existentes.
