...
- A tradução agora cobre strings dinâmicas usando patterns (`DescExtra`).
...
A localização está em desenvolvimento contínuo. Quase todo o texto no jogo (99%) foi traduzido para o Português Brasileiro, preservando a lógica e APIs originais.
